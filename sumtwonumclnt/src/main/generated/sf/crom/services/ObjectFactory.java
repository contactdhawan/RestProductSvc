 ...
 * generated in the sf.crom.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://services.crom.sf/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://services.crom.sf/", "sumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sf.crom.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.crom.sf/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.crom.sf/", name = "sumResponse")
